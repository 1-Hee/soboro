...
class SupervisedTrainer(object):
    ...
    def _save_epoch_result(self, train_result: list, valid_result: list) -> None:
        ...
        train_df.to_csv(SupervisedTrainer.TRAIN_RESULT_PATH, encoding="utf-8", index=False)
        valid_df.to_csv(SupervisedTrainer.VALID_RESULT_PATH, encoding="utf-8", index=False)
    ...
    def _save_step_result(self, train_step_result: dict, loss: float, cer: float) -> None:
        ...
        train_step_df.to_csv(SupervisedTrainer.TRAIN_STEP_RESULT_PATH, encoding="utf-8", index=False)
