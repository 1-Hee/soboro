...
class DataFeeder(threading.Thread):
  ...
  def _enqueue_next_group(self):
    ...
    examples = [self._get_next_example() for i in range(n * _batches_per_group)] # script, mel, length
...
def _prepare_batch(batch, outputs_per_step): # script, mel, length
